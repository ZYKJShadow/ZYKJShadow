...
<p align="center">
  专注于 <strong>AI Agent</strong>、<strong>Electron 桌面应用</strong>、<strong>React / TypeScript 工程化</strong><br/>
  正在把对 AI IDE 的理解，做成真正可运行、可迭代、可开源的产品。
</p>

<p align="center">
  <a href="https://github.com/ZYKJShadow/Async">代表项目：Async IDE</a> ·
  <a href="https://github.com/ZYKJShadow">GitHub</a>
</p>
...
- [Async IDE](https://github.com/ZYKJShadow/Async): 一个面向 AI Agent 工作流的开源桌面 IDE Shell
